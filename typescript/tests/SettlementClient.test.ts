...
describe("Test of SettlementClient - Using agent", function () {
    ...
    let settlementClientM: SettlementClientForShop;
    let settlementClient: SettlementClient;
    ...
    before(() => {
        ...
        settlementClientM = new SettlementClientForShop(network, shops[6].privateKey, shops[6].shopId);
        settlementClientM.setAgentOfRefund(refundAgent.address);
        settlementClientM.setAgentOfWithdrawal(withdrawalAgent.address);
    });
