...
public class SettlementClientTests
{
    ...
    public async Task Test05_CreateSettlementClient()
    {
        ...
        await settlementClientForManager.SetAgentOfRefund("0x0000000000000000000000000000000000000000");
        await settlementClientForManager.SetAgentOfWithdrawal("0x0000000000000000000000000000000000000000");
    ...
    {
        foreach (var client in settlementClientForShops)
        {
            await client.RemoveSettlementManager();
        }
    }
    ...
    public async Task Test11_UsePoint()
    {
        for (int i = 0; i < 6; i++)
        {
            ...
            System.Console.WriteLine("[0. Shop ID - " + shopClient.ShopId);
            
            System.Console.WriteLine("[1. Begin - Temporary Account]");
            temporaryAccount = await userClient.GetTemporaryAccount();
            System.Console.WriteLine("[1. End - Temporary Account]");
            
            System.Console.WriteLine("[2. Begin - Open New Payment]");
            ...
            System.Console.WriteLine("[2. End - Open New Payment]");
            
            await Task.Delay(1000);
            
            System.Console.WriteLine("[3. Begin - Approval New Payment]");
            ...
            System.Console.WriteLine("[3. End - Approval New Payment]");
            
            await Task.Delay(3000);
            
            System.Console.WriteLine("[4. Begin - Close New Payment]");
            var res2 = await paymentClient.CloseNewPayment(
                paymentItem.PaymentId,
                true
            );
            Assert.That(res.PaymentId, Is.EqualTo(paymentItem.PaymentId));
            System.Console.WriteLine("[4. END - Close New Payment]");
        }
    }
